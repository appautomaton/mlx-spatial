...
def compare_textured_glbs(
    ...
    *,
    ...
    """Compare GLB structure and embedded textures without claiming render proof."""
...
<head>
  <meta charset="utf-8">
  <title>mlx-spatial SpatialKit visual parity report</title>
  <style>
...
<body>
<main>
  <h1>mlx-spatial SpatialKit Visual Parity: {status}</h1>
