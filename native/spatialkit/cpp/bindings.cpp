...
NB_MODULE(_native, module) {
  module.doc() = "Native C++/Metal bindings for integrated mlx-spatial SpatialKit";
  ...
  module.def("backend_info", []() {
    ...
    info["cpu_framework"] = "native-c++";
    info["gpu_framework"] = "metal";
    info["gpu_execution_device"] = "apple-gpu";
    return info;
  ...
  module.def("fill_holes",
             &mlx_spatialkit::fill_holes,
             nb::arg("vertices"),
             nb::arg("faces"),
             nb::arg("max_hole_perimeter") = 0.03,
             "Fill clean boundary loops with the CuMesh perimeter centroid-fan contract.");

  module.def("unify_face_orientations",
             &mlx_spatialkit::unify_face_orientations,
             nb::arg("vertices"),
             nb::arg("faces"),
  ...
  module.def("remesh_narrow_band",
             ...
             "Build the CuMesh-compatible narrow-band UDF double cover.");

  module.def("point_to_mesh_distances",
             &mlx_spatialkit::point_to_mesh_distances,
             nb::arg("query_points"),
             nb::arg("vertices"),
             nb::arg("faces"),
             "Compute exact unsigned point-to-triangle distances with the shared native BVH.");

  module.def("repair_nonmanifold_mesh",
             &mlx_spatialkit::repair_nonmanifold_mesh,
             nb::arg("vertices"),
             nb::arg("faces"),
             "Split disconnected incident face fans to repair non-manifold topology.");

  module.def("build_mlx_qem_topology",
             &mlx_spatialkit::build_mlx_qem_topology,
             nb::arg("vertex_count"),
             nb::arg("faces"),
             "Build deterministic sorted edge and CSR topology for MLX QEM.");

  module.def("apply_mlx_qem_collapse_batch",
             &mlx_spatialkit::apply_mlx_qem_collapse_batch,
             nb::arg("vertices"),
             nb::arg("faces"),
             nb::arg("selected_edges"),
             nb::arg("boundary_vertices"),
             "Apply a conflict-free MLX QEM edge-collapse batch with native multicore compaction.");
  ...
  module.def("textured_glb_payload",
             ...
             nb::arg("generator") = "mlx-spatial SpatialKit",
