...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--output-dir", type=Path, help="directory for model.glb and trace.json")
    ...
    parser.add_argument(
        ...
        help="postprocess target before GLB export; avoid very low values for quality runs",
    )
    parser.add_argument(
        "--xatlas-face-guard",
        type=_parse_xatlas_face_guard,
        default="auto",
        help="maximum faces allowed into xatlas unwrap, or 'auto'",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help="texture voxel sampling backend; kdtree is current best visual default, trilinear is parity-oriented",
    )
